 ...
 * NPN: Emitter arrow away from base. If emitter is much lower than base then it connects to collector.
 * PNP: Emitter arrow toward base. If emitter is much higher than base then it connects to collector.
 * @author Ted
 *
 */
